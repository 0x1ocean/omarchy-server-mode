...
- Released the original local Server Mode toggle as the public Remote Server Mode plugin.
...
- Made left click open the panel and right click toggle Remote Server Mode.
